...
Since there is flag **-sV** used, which allows to determine the version of the services running on this machine.
...
- Option **dir** is used, since we are finding hidden directories
...
3. Upload the .phtml file to the upload form, which you can find it at relative URL **_/internal/uploads/_**
...
4. Execute that unit file by using **systemctl** binary
   ...
   - Option **enable** _enables_ the specified unit file to be executed
